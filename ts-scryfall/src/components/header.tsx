    ...
    return (
      <div id="header" className="header">
        <div className="inner-flex">
          ...
          <a className="header-logo" title="Back to homepage" href="/">
          ...
          <div className={`header-utility ${isMenuOpen ? '' : 'header-utility-closed'}`}>
            <a className="header-utility-link header-mobile-only" href="/">
            ...
            <a className="header-utility-link" href="/advanced">
            ...
            <a className="header-utility-link" href="/sets">
            ...
            <a className="header-utility-link" href="/random">
            ...
            <a className="header-utility-link header-mobile-only" href="/saved">
