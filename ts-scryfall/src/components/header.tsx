    ...
    return (
      <div id="header" className="header">
        <div className="inner-flex">
          ...
          <Link to={`${process.env.PUBLIC_URL}/`} className="header-logo" title="Back to homepage">
          ...
          <div className={`header-utility ${isMenuOpen ? '' : 'header-utility-closed'}`}>
            <Link to={`${process.env.PUBLIC_URL}/`} className="header-utility-link header-mobile-only">
            ...
            <Link to={`${process.env.PUBLIC_URL}/advanced`} className="header-utility-link">
            ...
            <Link to={`${process.env.PUBLIC_URL}/reference`} className="header-utility-link">
            ...
            <Link to={`${process.env.PUBLIC_URL}/sets`} className="header-utility-link">
            ...
            <Link to={`${process.env.PUBLIC_URL}/random`} className="header-utility-link">
            ...
            <Link to={`${process.env.PUBLIC_URL}/saved`} className="header-utility-link header-mobile-only">
